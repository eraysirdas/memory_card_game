...
namespace başladıkbagalım
{
    public partial class Form6 : Form
    {
        ...
        private void Form6_Load(object sender, EventArgs e)
        {
            ...
            kart7.Image = Properties.Resources._7;
            kart_7.Image = Properties.Resources._7; 
            kart8.Image= Properties.Resources._8;
            kart_8.Image= Properties.Resources._8;  
        }
        ...
        private void kart1_Click(object sender, EventArgs e)
        {
            ...
            if (birinciresim != null && ikinciresim != null)
            {
                ...
                else
                {
                    ...
                    kart7.Enabled = false;
                    kart_7.Enabled = false;
                    kart8.Enabled = false;
                    kart_8.Enabled = false;
                }
            }
        }
        ...
        private void kart_7_Click(object sender, EventArgs e)
        {
            kart_7.Image = Properties.Resources._7;
            kart_7.Enabled = false;
            if (birinciresim == null)
        ...
        private void kart_8_Click(object sender, EventArgs e)
        {
            kart_8.Image = Properties.Resources._8;
            kart_8.Enabled = false;
            if (birinciresim == null)
        ...
        {
            if (kart_7.Enabled == false || kart7.Enabled == false)
            {
                timer11.Stop();
                kart7.Visible = false;
                kart_7.Visible = false;
                oyunbitti();
            }
        }
        ...
        {
            if (kart_8.Enabled == false || kart8.Enabled == false)
            {
                timer12.Stop();
                kart8.Visible = false;
                kart_8.Visible = false;
                oyunbitti();
            }
        }
        ...
        {
            if (kart1.Visible == false && kart2.Visible == false && kart3.Visible == false && kart4.Visible == false && kart5.Visible == false && kart6.Visible == false && kart7.Visible == false && kart8.Visible == false && kart_1.Visible == false && kart_2.Visible == false && kart_3.Visible == false && kart_4.Visible == false && kart_5.Visible == false && kart_6.Visible == false && kart_7.Visible == false && kart_8.Visible == false)
            {
                timer10.Stop();
